...
\begin{titlepage}
	\begin{adjustwidth}{-1.5cm}{0cm}
		...
		\begin{center}
			...
			\textsc{\Large Grado en Ingeniería Informática en Ingeniería Software}\\[3cm]
			\textsc{\Large Trabajo Fin de Grado}\\[0.5cm]
			{ \large \bfseries Transformación Digital en Instituciones Públicas}\\[4.0cm]
			\vfill
			% Bottom of the page
			{\large}
		\end{center}
...
\begin{titlepage}
	\begin{adjustwidth}{-1.5cm}{0cm}
		...
		\begin{center}
			...
			\textsc{\Large Escuela Politécnica}\\[0.5cm]
			\textsc{\Large Grado de Ingeniería Informática en Ingeniería Software}\\[2.5cm]
			\textsc{\Large Trabajo Fin de Grado}\\[0.5cm]
			{ \large \bfseries Transformación Digital en Instituciones Públicas}\\[4.0cm]			
			{ \large \bfseries Autor: Daniel Campos Olivares}\\[0.5cm]
			{ \large \bfseries Tutor: Pablo García Rodríguez}\\[0.5cm]
...
% Aquí el resumen en inglés si el tutor lo requiere.		
